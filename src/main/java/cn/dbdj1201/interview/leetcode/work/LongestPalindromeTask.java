...
//    }
    ...
    public static String longestPalindromeCopy2(String s) {
        if (s == null || s.length() < 1) {
            return "";
        }
        int start = 0, end = 0;
        for (int i = 0; i < s.length(); i++) {
            int len1 = expandAroundCenterCopy2(s, i, i);
            int len2 = expandAroundCenterCopy2(s, i, i + 1);
    ...
    public static int expandAroundCenterCopy2(String s, int left, int right) {
