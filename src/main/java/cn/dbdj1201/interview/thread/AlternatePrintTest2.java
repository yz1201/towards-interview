...
public class AlternatePrintTest2 {
    public static void main(String[] args) throws InterruptedException {
        AwaitSignal awaitSignal = new AwaitSignal(50000);
        ...
        new Thread(() -> awaitSignal.print("a", a_condition, b_condition), "Thread-a").start();
        new Thread(() -> awaitSignal.print("b", b_condition, c_condition), "Thread-b").start();
        new Thread(() -> awaitSignal.print("c", c_condition, a_condition), "Thread-c").start();
